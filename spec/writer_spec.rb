...
RSpec.describe MiniTarball::Writer do
  ...
  describe "#fill" do
    it "adds file at the beginning of tar file" do
      MiniTarball::Writer.use(io) do |writer|
        placeholder =
          writer.reserve(name: "file1.txt", size: File.size(fixture_path("files/file1.txt")))
    ...
    it "adds file in the middle of tar file" do
      MiniTarball::Writer.use(io) do |writer|
        ...
        placeholder =
          writer.reserve(name: "file2.txt", size: File.size(fixture_path("files/file2.txt")))
    ...
    it "supports adding multiple files via placeholder" do
      MiniTarball::Writer.use(io) do |writer|
        ...
        placeholder2 =
          writer.reserve(name: "file2.txt", size: File.size(fixture_path("files/file2.txt")))
        placeholder3 =
          writer.reserve(name: "file3.txt", size: File.size(fixture_path("files/file3.txt")))
    ...
    it "supports adding a file that is smaller than the placeholder" do
      MiniTarball::Writer.use(io) do |writer|
        placeholder =
          writer.reserve(name: "file1.txt", size: File.size(fixture_path("files/file1.txt")) + 1492)
    ...
    it "raises an error if the file is larger than the placeholder" do
      MiniTarball::Writer.use(io) do |writer|
        placeholder =
          writer.reserve(name: "file1.txt", size: File.size(fixture_path("files/file1.txt")) - 100)
